...
contract('CrowdSale',function(accounts){
  ...
  var tokenInstance;
  var buyer = '0x419AeE5325C9F85f63E086c337649DF448a5feb4';
  var admin = '0xD951F0a30a6a783aD8858647D73d2a9c07ab0a31';
  ...
  it('initialize the contract with correct value', function(){
    return CrowdSale.deployed().then(function(instance){
      ...
      assert.equal(admin,0xD951F0a30a6a783aD8858647D73d2a9c07ab0a31,"checks admin");
