...
const vbtBalanceEL = document.getElementById('vbt-balance');
...
const main= async() => {  
  ...
  vbtBalance = await contract2.methods.balanceOf(account).call();
  console.log("User Balance : ",vbtBalance);
  vbtBalanceEL.innerHTML = vbtBalance;
